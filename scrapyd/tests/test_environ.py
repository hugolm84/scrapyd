...
class EnvironmentTest(unittest.TestCase):
    ...
    def test_get_environment_with_eggfile(self):
        ...
        self.assert_(env['SCRAPY_LOG_FILE'].endswith(os.path.join('mybot', 'myspider', 'ID', 'ID.log')))
        self.assert_(env['SCRAPY_FEED_URI'].endswith(os.path.join('mybot', 'myspider', 'ID', 'ID.json')))
